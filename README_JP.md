...
v1.0.1 の Win64 バイナリリリースは、Epic Games Launcher 版 Unreal Engine 5.7.4 (`++UE5+Release-5.7`) でビルドしたものです。Launcher 版 UE 5.7.x プロジェクト向けに利用できます。ソースビルド、ライセンシー版、カスタム版、または異なるエンジンビルドで使う場合は、ソースから再ビルドしてください。
