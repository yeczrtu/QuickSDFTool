...
<div class="screenshot-grid">
  <figure class="screenshot-card">
    ...
    <figcaption>
      ...
      Select/prep state with target mesh, Material Slots, selected row, and cyan active-slot overlay.
    </figcaption>
  </figure>
  <figure class="screenshot-card">
    ...
    <figcaption>
      ...
      Paint mode using Screen projection with brush preview, UV texture preview, material slot list, and timeline context.
    </figcaption>
  </figure>
  <figure class="screenshot-card compact">
    ...
    <figcaption>
      ...
      Close-up timeline controls, seek/keyframe lanes, thumbnails, and angle labels.
    </figcaption>
  </figure>
  <figure class="screenshot-card compact">
    ...
    <figcaption>
      ...
      Generated SDF threshold map preview.
    </figcaption>
  </figure>
</div>
